        ...
        /*async Task<EngineData> LoadData() {
            ...
            await Task.Factory.StartNew(delegate {
                using (WebClient wc = new WebClient()) {
                    dummy = JsonSerializer.Deserialize<EngineData>(wc.DownloadStringTaskAsync("https://raw.githubusercontent.com/The-Architect01/Dungeons-and-Dragons-Player-Maker/master/Test.json").Result, Engine.JsonSerializerOptions);
